...
<body>
	<c:if test="${post ne null}"><!-- 같지않으면 -->
		...
		<div class="form-group">
			...
			<div class="form-group">
			<label>작성일:</label>
			<div class="form-control"><fmt:formatDate value="${post.po_date }" pattern="yyyy.MM.dd" /></div>			
		</div>
			<div class="form-group">
			<label>조회수:</label>
	...
	<a href="<c:url value="/post/list?co_num=${post.po_num }"/>" class="btn btn-outline-info">목록</a>
